...
export const PathModule : React.FunctionComponent = () => <div className="hexagon">
  <svg width="61" height="66" viewBox="0 0 61 66" fill="none" xmlns="http://www.w3.org/2000/svg">
     ...
     />
      ...
      <svg width="88" height="22" viewBox="0 0 21 22" fill="none" xmlns="http://www.w3.org/2000/svg" visibility="hidden"
            className={classnames({
              checkmark: mockModule.completed
            })}
            >
          <path fill-rule="evenodd" 
                ...
                fill="#0DD2AB"/>
          <path d="M8.92778 15.7434L4.50586 11.3215L6.43267 9.39472L8.92778 11.8899L14.567 6.25061L16.4938 8.17742L8.92778 15.7434Z" 
                fill="white"/>
      </svg>
  </svg>
</div>;
